...
const showCharacter = character => {
    ...
    characterDetail.appendChild(createParagraph("Personaje: " + character.name));
    characterDetail.appendChild(
        createParagraph("Fecha de nacimiento: " + character.birthday)
    );
    characterDetail.appendChild(
        createParagraph("Mote o diminutivo: " + character.nickname)
    );
};
